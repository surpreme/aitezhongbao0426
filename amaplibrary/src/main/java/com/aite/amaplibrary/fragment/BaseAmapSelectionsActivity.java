...
import com.aite.amaplibrary.adapter.SearchResultAdapter;
import com.aite.amaplibrary.views.SegmentedGroup;
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if (position != searchResultAdapter.getSelectedPosition()) {
                ...
                if (getIntent().getStringExtra("TYPE") != null) {
                    if (getIntent().getStringExtra("TYPE").equals("CHOICE_ADDRESS")) {
                        Intent intent = getIntent();
                        intent.putExtra("LocationName", poiItem.getTitle());

                        intent.putExtra("LatitudeLongitude", String.format("%s,%s", poiItem.getLatLonPoint().getLatitude(), poiItem.getLatLonPoint().getLongitude()));
                        // 设置返回码和返回携带的数据
