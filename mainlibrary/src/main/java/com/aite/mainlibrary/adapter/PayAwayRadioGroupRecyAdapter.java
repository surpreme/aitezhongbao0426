...
public class PayAwayRadioGroupRecyAdapter extends RecyclerView.Adapter<PayAwayRadioGroupRecyAdapter.ViewHolder> {

    private Context context;
    private LayoutInflater inflater;
    private List<? extends IBaseBean> listBean;

    public PayAwayRadioGroupRecyAdapter(Context context, /*TestBean testBean*/List<? extends IBaseBean> bean) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.payaway_radiogroup_recy_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.ivImg.setImageDrawable(context.getResources().getDrawable(listBean.get(position).isIsCheck() ?
                R.drawable.ic_pay_ok : R.drawable.ic_pay_un));
