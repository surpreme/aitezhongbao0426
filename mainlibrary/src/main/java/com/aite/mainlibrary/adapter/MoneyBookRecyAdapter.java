 ...
 * @desc:
 */
public class MoneyBookRecyAdapter extends RecyclerView.Adapter<MoneyBookRecyAdapter.ViewHolder> {
    private Context context;
    private LayoutInflater inflater;
    private List<MoneyBookBean.ListLogBean> datasBeans;

    public MoneyBookRecyAdapter(Context context, List<MoneyBookBean.ListLogBean> datasBeans) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_money_book_recy, parent, false);
