...
public class HelpEatHouseTypeRecyAdapter extends RecyclerView.Adapter<HelpEatHouseTypeRecyAdapter.ViewHolder> {

    private Context context;
    private LayoutInflater inflater;
    private List<HelpEatUIBean.NursingListBean> classBeans;

    public HelpEatHouseTypeRecyAdapter(Context context, List<HelpEatUIBean.NursingListBean> classBeans) {
